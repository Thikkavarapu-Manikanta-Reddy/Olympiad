...
$sqlc = "SELECT result FROM ans1 WHERE  result ='$one' ";
$sqlw = "SELECT result FROM ans1 WHERE ID ='1'";
...
$sqlc = "SELECT result FROM ans1 WHERE result = '$two'";
$sqlw = "SELECT result FROM ans1 WHERE ID ='2'";
...
$sqlc = "SELECT result FROM ans1 WHERE  result ='$three' ";
$sqlw = "SELECT result FROM ans1 WHERE ID ='3'";
...
$sqlc = "SELECT result FROM ans1 WHERE  result ='$four' ";
$sqlw = "SELECT result FROM ans1 WHERE ID ='4'";
...
$sqlc = "SELECT result FROM ans1 WHERE  result ='$five' ";
$sqlw = "SELECT result FROM ans1 WHERE ID ='5'";
...
$sqlc = "SELECT result FROM ans1 WHERE  result ='$six' ";
$sqlw = "SELECT result FROM ans1 WHERE ID ='6'";
...
$sqlc = "SELECT result FROM ans1 WHERE  result ='$seven' ";
$sqlw = "SELECT result FROM ans1 WHERE ID ='7'";
...
$sqlc = "SELECT result FROM ans1 WHERE  result ='$eight' ";
$sqlw = "SELECT result FROM ans1 WHERE ID ='8'";
...
$sqlc = "SELECT result FROM ans1 WHERE  result ='$nine' ";
$sqlw = "SELECT result FROM ans1 WHERE ID ='9'";
...
$sqlc = "SELECT result FROM ans1 WHERE  result ='$ten' ";
$sqlw = "SELECT result FROM ans1 WHERE ID ='10'";
