...
<br><br>
<form action="correction" method="post" id="dateForm" style="font-family: 'Ranchers', cursive;">
   <div class="container-fluid" id="1">
  
    <div class="tick" >
   <h1>1.How many sides are there in a cube?</h1>
   
  <input type="radio" name="numbers" value="8" >8<br>
  <input type="radio" name="numbers" value="6">6<br>
  <input type="radio" name="numbers" value="12">12<br><br> 
...
<br>
 <div class="container-fluid" id="2">
    ...
    <div class="tick">
   <h1>2.Which of the following animals will bark?</h1>
  <input type="radio" name="animals" value="Camel">Camel<br>
  <input type="radio" name="animals" value="Cat">Cat<br>
  <input type="radio" name="animals" value="Dog">Dog<br><br> 
 ...
 <div class="container-fluid" id="3">
    ...
    <div class="tick">
   <h1>3.Which of the following authors wrote "HarryPotter" StoryBook?</h1>
  <input type="radio" name="authors" value="J.K.Rowling">J.K.Rowling<br>
  <input type="radio" name="authors" value="StephenKing">StephenKing<br>
  <input type="radio" name="authors" value="VirginiaWoolf">VirginiaWoolf<br><br> 
 ...
 <div class="container-fluid" id="4">
    ...
    <div class="tick">
   <h1>4.Entomology is the science that studies?</h1>
  <input type="radio" name="science" value="Birds">Birds<br>
  <input type="radio" name="science" value="Humans">Humans<br>
  <input type="radio" name="science" value="Insects">Insects<br><br> 
 ...
 <div class="container-fluid" id="5">
    ...
    <div class="tick">
   <h1>5.How many basic sense organs are there for humanbeings?</h1>
  <input type="radio" name="sense" value="4">4<br>
  <input type="radio" name="sense" value="5">5<br>
  <input type="radio" name="sense" value="7">7<br><br> 
 ...
 <div class="container-fluid" id="6">
    ...
    <div class="tick">
   <h1>6.The 'Black flag' signifies?</h1>
  <input type="radio" name="flag" value="peace">peace<br>
  <input type="radio" name="flag" value="protest">protest<br>
  <input type="radio" name="flag" value="truce">truce<br><br> 
 ...
 <div class="container-fluid" id="7">
    ...
    <div class="tick">
   <h1>7.Hitler party which came into power in 1933 is known as?</h1>
  <input type="radio" name="party" value="DemocraticParty">DemocraticParty<br>
  <input type="radio" name="party" value="NaziParty">NaziParty<br>
  <input type="radio" name="party" value="LabourParty">LabourParty<br><br> 
 ...
 <div class="container-fluid" id="8">
    ...
    <div class="tick">
   <h1>8.Fastest shorthand writer was?</h1>
  <input type="radio" name="writer" value="Dr.G.D.Bist">Dr.G.D.Bist<br>
  <input type="radio" name="writer" value="J.M.Tagore">J.M.Tagore<br>
  <input type="radio" name="writer" value="J.R.D.Tata">J.R.D.Tata<br><br> 
 ...
 <div class="container-fluid" id="9">
    ...
    <div class="tick">
   <h1>9.Epsom (England) is the place associated with?</h1>
  <input type="radio" name="place" value="Horseracing">Horseracing<br>
  <input type="radio" name="place" value="Shooting">Shooting<br>
  <input type="radio" name="place" value="Snooker">Snooker<br><br> 
 ...
 <div class="container-fluid" id="10">
    ...
    <div class="tick">
   <h1>10.Philology is the study of?</h1>
  <input type="radio" name="study" value="bones">bones<br>
  <input type="radio" name="study" value="architecture">architecture<br>
  <input type="radio" name="study" value="languages">languages<br><br> 
