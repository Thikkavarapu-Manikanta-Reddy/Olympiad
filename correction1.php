  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav" id="a1">
        ...
        <li class="dropdown">
          ...
          <ul  class="dropdown-menu">
            ...
            <li><a href="#" class="butt" id="ans1"  >Question no:1</a></li>
            ...
            <li><a href="#" class="butt" id="ans10">Question no:10</a></li>
            </div>
          </ul>
        </li>
      </ul>
      <ul class="nav navbar-nav navbar-right" id="a1">
        ...
        <li><a href="leaderboard" style="font-family: 'Ranchers', cursive;"><span class="glyphicon glyphicon-home"></span>&nbsp&nbspLeaderboard</a></li>
      </ul>
    </div>
  </div>
</nav>
...
$sqlc = "SELECT result FROM ans WHERE  result ='$one' ";
$sqlw = "SELECT result FROM ans WHERE ID ='1'";
...
$sqlc = "SELECT result FROM ans WHERE result = '$two'";
$sqlw = "SELECT result FROM ans WHERE ID ='2'";
...
$sqlc = "SELECT result FROM ans WHERE  result ='$three' ";
$sqlw = "SELECT result FROM ans WHERE ID ='3'";
...
$sqlc = "SELECT result FROM ans WHERE  result ='$four' ";
$sqlw = "SELECT result FROM ans WHERE ID ='4'";
...
$sqlc = "SELECT result FROM ans WHERE  result ='$five' ";
$sqlw = "SELECT result FROM ans WHERE ID ='5'";
...
$sqlc = "SELECT result FROM ans WHERE  result ='$six' ";
$sqlw = "SELECT result FROM ans WHERE ID ='6'";
...
$sqlc = "SELECT result FROM ans WHERE  result ='$seven' ";
$sqlw = "SELECT result FROM ans WHERE ID ='7'";
...
$sqlc = "SELECT result FROM ans WHERE  result ='$eight' ";
$sqlw = "SELECT result FROM ans WHERE ID ='8'";
...
$sqlc = "SELECT result FROM ans WHERE  result ='$nine' ";
$sqlw = "SELECT result FROM ans WHERE ID ='9'";
...
$sqlc = "SELECT result FROM ans WHERE  result ='$ten' ";
$sqlw = "SELECT result FROM ans WHERE ID ='10'";
...
$user = $_SESSION["user"];
 ...
 $sql="UPDATE signup SET MARKS = '$mark' WHERE NAME='$user'";
...
<div class="container-fluid">
   ...
   <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4"></div>
   <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
     <center><a href="leaderboard" style="background-color:#00BFFF;" class="butto">Leaderboard</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="examstart" style="background-color:#00BFFF;"  class="butto">Home</a></center>
   </div>
   </div>
   <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
   </div>
  ...
  <div class="container-fluid">
  <div class="lick">
<center><h1>THANK YOU FOR TAKING THE EXAM</h1></center>
<center><h3>HOPE YOU ENJOYED WITH THE QUESTIONS</h3></center>
<br>
<center><a href="#" data-toggle="modal" data-target="#feed" class="butto">Feedback</a></center>
<br>
...
<center><h1 style="font-family: 'Ranchers', cursive;color:black;">FEED<span style="color: white;">BACK</span></h1></center>
</div></center>
</div>
<div class="modal-body">
           <div class="container-fluid">
    <div class="lick">
<form  action="examstart" method="post">
