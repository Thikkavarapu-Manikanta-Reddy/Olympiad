...
<br><br><br>
<div class="container">
<center><div class="men" style="width:40%;">
<center><h1 style="font-family: 'Ranchers', cursive;color:black;">LEADER<span style="color: white;">BOARD</span></h1></center>
</div></center>
</div>
...
$sql = "SELECT NAME,MARKS,RANK FROM signup ORDER BY RANK ";
...
while($row = $result->fetch_assoc())
{
  ...
  <tr>
    ...
    <td>"."<h2>".$row['MARKS']."</h2>"."</td>
    <td>"."<h2>".$row['RANK']."</h2>"."</td>  
    </tr>
    </tbody>";
  }
  echo "</table>";
...
<br>
<div class="container-fluid">
  <center><button type="submit" onclick="location.href='examstart'" class="btn btn-info">Home</button></center>
</div>
<br>
